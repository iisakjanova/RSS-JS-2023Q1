...
var Minesweeper = /*#__PURE__*/_createClass(function Minesweeper(container, rows, cols) {
  var _this = this;
  ...
  _defineProperty(this, "addMinesToBoardData", function (firstMoveRow, firstMoveCol) {
    var numMines = Math.floor(_this.rows * _this.cols * 0.1);
    var minesPlaced = 0;
  ...
  _defineProperty(this, "openCellIfEmpty", function (rowStr, colStr) {
    ...
    if (col < 0 || col > _this.boardData[row].length - 1) {
      return;
    }
    if (_this.boardData[row][col] === 1) {
      return;
    }
    var cell = document.querySelector("[data-row=\"".concat(row, "\"][data-col=\"").concat(col, "\"]"));
    var isOpen = cell.disabled;
    if (isOpen) {
      return;
    }
  ...
  _defineProperty(this, "openCell", function (cell, result) {
    ...
    if (result !== 'mine' && _this.openedCells === _this.boardData[0].length * _this.boardData.length - 10) {
      _this.success = true;
      _this.revealBoard();
      _this.endGame();
    }
  ...
  _defineProperty(this, "showMessage", function (text) {
  ...
  _defineProperty(this, "endGame", function () {
    ...
    var message = _this.success ? "Hooray! You found all mines in ".concat(_this.duration, " seconds and ").concat(_this.counter, " moves!") : 'Game over. Try again.';
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "*,\n::before,\n::after {\n    box-sizing: border-box;\n}\n\n.board {\n  margin: 0 auto;\n  width: 500px;\n  display: flex;\n  flex-wrap: wrap;\n}\n\n.cell {\n  width: 50px;\n  height: 50px;\n}\n\n.opened {\n  background-color: lightgreen;\n}\n\n.opened.mine {\n  background-color: pink;\n}\n\n.message {\n  height: 20px;\n}\n\n.cell:disabled {\n  color: black;\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;;;IAGI,sBAAsB;AAC1B;;AAEA;EACE,cAAc;EACd,YAAY;EACZ,aAAa;EACb,eAAe;AACjB;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA;EACE,4BAA4B;AAC9B;;AAEA;EACE,sBAAsB;AACxB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,YAAY;AACd","sourcesContent":["*,\n::before,\n::after {\n    box-sizing: border-box;\n}\n\n.board {\n  margin: 0 auto;\n  width: 500px;\n  display: flex;\n  flex-wrap: wrap;\n}\n\n.cell {\n  width: 50px;\n  height: 50px;\n}\n\n.opened {\n  background-color: lightgreen;\n}\n\n.opened.mine {\n  background-color: pink;\n}\n\n.message {\n  height: 20px;\n}\n\n.cell:disabled {\n  color: black;\n}\n"],"sourceRoot":""}]);
// Exports
...
startBtn.addEventListener('click', function () {
  ...
  minesweeper = new _minesweeperBoard__WEBPACK_IMPORTED_MODULE_1__["default"](container, 10, 10);
  minesweeper.start();
});
minesweeper = new _minesweeperBoard__WEBPACK_IMPORTED_MODULE_1__["default"](container, 10, 10);
minesweeper.start();
