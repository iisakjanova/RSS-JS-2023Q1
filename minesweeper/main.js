...
var Minesweeper = /*#__PURE__*/_createClass(function Minesweeper(container, rows, cols, mines) {
  var _this = this;
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "*,\n::before,\n::after {\n    box-sizing: border-box;\n}\n\n#page {\n  margin-bottom: 50px;\n}\n\n.dark-mode {\n  background: #444444;\n  color: white;\n}\n\n.title {\n  text-align: center;\n}\n\n.game-mode-part {\n  display: flex;\n  justify-content: space-between;\n}\n\n.start-btn {\n  background: linear-gradient(to bottom right, #C7E9FF, #A4D4FF);\n  border: #A4D4FF;\n  border-radius: 2px;\n  padding: 5px;\n  width: 100px;\n}\n\n.dark-mode .start-btn {\n  background: linear-gradient(to bottom right, #0000CD, #000080);\n  color: white;\n}\n\n.start-btn:hover {\n  background: linear-gradient(to top left, #C7E9FF, #A4D4FF);\n}\n\n.dark-mode .start-btn:hover {\n  background: linear-gradient(to top left,#0000CD, #000080);\n}\n\n.settings-game-form {\n  display: flex;\n  flex-direction: column;\n}\n\n.settings-label {\n  align-self: center;\n}\n\n.settings-item {\n  display: flex;\n  justify-content: space-between;\n}\n\n.settings-input,\n.switch-color-select {\n  border: 1px solid #8bc6f9;\n}\n\n.dark-mode .settings-input,\n.dark-mode .switch-color-select {\n  background: transparent;\n  color: white;\n}\n\n.settings-btn {\n  background: linear-gradient(to bottom right, #C7E9FF, #A4D4FF);\n  border: #A4D4FF;\n  border-radius: 2px;\n}\n\n.dark-mode .settings-btn {\n  background: linear-gradient(to bottom right, #0000CD, #000080);\n  color: white;\n}\n\n.settings-btn:hover {\n  background: linear-gradient(to top left, #C7E9FF, #A4D4FF);\n}\n\n.dark-mode .settings-btn:hover {\n  background: linear-gradient(to top left,#0000CD, #000080);\n}\n\n.info {\n  display: flex;\n  justify-content: space-between;\n  margin: 0 10px;\n}\n\n.container {\n  max-width: 500px;\n  padding: 0 10px;\n  margin: 0 auto;\n}\n\n.board {\n  margin: 0 auto;\n  display: flex;\n  flex-direction: column;\n  border-radius: 3px;\n  border: 2px solid #76b8f3;\n}\n\n.row {\n  display: flex;\n}\n\n.cell {\n  width: 10%;\n  max-width: 50px;\n  background: radial-gradient(circle at center, #C7E9FF, #A4D4FF);\n  aspect-ratio: 1/1;\n  box-shadow: 0 2px 6px rgba(0, 0, 0, 0.3); \n  transition: box-shadow 0.3s ease;\n  border: 1px solid #8bc6f9;\n  padding: 0;\n}\n\n.dark-mode .cell {\n  background: radial-gradient(circle at center, #0000CD, #000080);\n}\n\n.cell:hover:not(:disabled){\n  background: radial-gradient(circle at center, #A4D4FF, #C7E9FF);\n  box-shadow: 0 4px 10px rgba(0, 0, 0, 0.5);\n}\n\n.dark-mode .cell:hover:not(:disabled){\n  background: radial-gradient(circle at center, #000080, #0000CD);\n}\n\n.opened {\n  background: #b4d6f0;\n  box-shadow: none;\n  border: 1px solid #8bc6f9;\n}\n\n.dark-mode .opened {\n  background: #0471c4;\n  box-shadow: none;\n  border: 1px solid #8bc6f9;\n}\n\n.opened.mine {\n  background-color: pink;\n}\n\n.message {\n  height: 20px;\n  text-align: center;\n}\n\n.cell:disabled {\n  color: black;\n}\n\n.switch-color-label {\n  text-align: center;\n}\n\n.switch-color-select {\n  display: block;\n  margin: 0 auto;\n  padding: 10px;\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;;;IAGI,sBAAsB;AAC1B;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,mBAAmB;EACnB,YAAY;AACd;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,8BAA8B;AAChC;;AAEA;EACE,8DAA8D;EAC9D,eAAe;EACf,kBAAkB;EAClB,YAAY;EACZ,YAAY;AACd;;AAEA;EACE,8DAA8D;EAC9D,YAAY;AACd;;AAEA;EACE,0DAA0D;AAC5D;;AAEA;EACE,yDAAyD;AAC3D;;AAEA;EACE,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,8BAA8B;AAChC;;AAEA;;EAEE,yBAAyB;AAC3B;;AAEA;;EAEE,uBAAuB;EACvB,YAAY;AACd;;AAEA;EACE,8DAA8D;EAC9D,eAAe;EACf,kBAAkB;AACpB;;AAEA;EACE,8DAA8D;EAC9D,YAAY;AACd;;AAEA;EACE,0DAA0D;AAC5D;;AAEA;EACE,yDAAyD;AAC3D;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,cAAc;AAChB;;AAEA;EACE,gBAAgB;EAChB,eAAe;EACf,cAAc;AAChB;;AAEA;EACE,cAAc;EACd,aAAa;EACb,sBAAsB;EACtB,kBAAkB;EAClB,yBAAyB;AAC3B;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,UAAU;EACV,eAAe;EACf,+DAA+D;EAC/D,iBAAiB;EACjB,wCAAwC;EACxC,gCAAgC;EAChC,yBAAyB;EACzB,UAAU;AACZ;;AAEA;EACE,+DAA+D;AACjE;;AAEA;EACE,+DAA+D;EAC/D,yCAAyC;AAC3C;;AAEA;EACE,+DAA+D;AACjE;;AAEA;EACE,mBAAmB;EACnB,gBAAgB;EAChB,yBAAyB;AAC3B;;AAEA;EACE,mBAAmB;EACnB,gBAAgB;EAChB,yBAAyB;AAC3B;;AAEA;EACE,sBAAsB;AACxB;;AAEA;EACE,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,cAAc;EACd,cAAc;EACd,aAAa;AACf","sourcesContent":["*,\n::before,\n::after {\n    box-sizing: border-box;\n}\n\n#page {\n  margin-bottom: 50px;\n}\n\n.dark-mode {\n  background: #444444;\n  color: white;\n}\n\n.title {\n  text-align: center;\n}\n\n.game-mode-part {\n  display: flex;\n  justify-content: space-between;\n}\n\n.start-btn {\n  background: linear-gradient(to bottom right, #C7E9FF, #A4D4FF);\n  border: #A4D4FF;\n  border-radius: 2px;\n  padding: 5px;\n  width: 100px;\n}\n\n.dark-mode .start-btn {\n  background: linear-gradient(to bottom right, #0000CD, #000080);\n  color: white;\n}\n\n.start-btn:hover {\n  background: linear-gradient(to top left, #C7E9FF, #A4D4FF);\n}\n\n.dark-mode .start-btn:hover {\n  background: linear-gradient(to top left,#0000CD, #000080);\n}\n\n.settings-game-form {\n  display: flex;\n  flex-direction: column;\n}\n\n.settings-label {\n  align-self: center;\n}\n\n.settings-item {\n  display: flex;\n  justify-content: space-between;\n}\n\n.settings-input,\n.switch-color-select {\n  border: 1px solid #8bc6f9;\n}\n\n.dark-mode .settings-input,\n.dark-mode .switch-color-select {\n  background: transparent;\n  color: white;\n}\n\n.settings-btn {\n  background: linear-gradient(to bottom right, #C7E9FF, #A4D4FF);\n  border: #A4D4FF;\n  border-radius: 2px;\n}\n\n.dark-mode .settings-btn {\n  background: linear-gradient(to bottom right, #0000CD, #000080);\n  color: white;\n}\n\n.settings-btn:hover {\n  background: linear-gradient(to top left, #C7E9FF, #A4D4FF);\n}\n\n.dark-mode .settings-btn:hover {\n  background: linear-gradient(to top left,#0000CD, #000080);\n}\n\n.info {\n  display: flex;\n  justify-content: space-between;\n  margin: 0 10px;\n}\n\n.container {\n  max-width: 500px;\n  padding: 0 10px;\n  margin: 0 auto;\n}\n\n.board {\n  margin: 0 auto;\n  display: flex;\n  flex-direction: column;\n  border-radius: 3px;\n  border: 2px solid #76b8f3;\n}\n\n.row {\n  display: flex;\n}\n\n.cell {\n  width: 10%;\n  max-width: 50px;\n  background: radial-gradient(circle at center, #C7E9FF, #A4D4FF);\n  aspect-ratio: 1/1;\n  box-shadow: 0 2px 6px rgba(0, 0, 0, 0.3); \n  transition: box-shadow 0.3s ease;\n  border: 1px solid #8bc6f9;\n  padding: 0;\n}\n\n.dark-mode .cell {\n  background: radial-gradient(circle at center, #0000CD, #000080);\n}\n\n.cell:hover:not(:disabled){\n  background: radial-gradient(circle at center, #A4D4FF, #C7E9FF);\n  box-shadow: 0 4px 10px rgba(0, 0, 0, 0.5);\n}\n\n.dark-mode .cell:hover:not(:disabled){\n  background: radial-gradient(circle at center, #000080, #0000CD);\n}\n\n.opened {\n  background: #b4d6f0;\n  box-shadow: none;\n  border: 1px solid #8bc6f9;\n}\n\n.dark-mode .opened {\n  background: #0471c4;\n  box-shadow: none;\n  border: 1px solid #8bc6f9;\n}\n\n.opened.mine {\n  background-color: pink;\n}\n\n.message {\n  height: 20px;\n  text-align: center;\n}\n\n.cell:disabled {\n  color: black;\n}\n\n.switch-color-label {\n  text-align: center;\n}\n\n.switch-color-select {\n  display: block;\n  margin: 0 auto;\n  padding: 10px;\n}\n"],"sourceRoot":""}]);
// Exports
...
startBtn.addEventListener('click', function () {
  ...
  minesweeper = new _minesweeperBoard__WEBPACK_IMPORTED_MODULE_1__["default"](container, size, size, minesQty);
  minesweeper.start();
});
...
minesweeper = new _minesweeperBoard__WEBPACK_IMPORTED_MODULE_1__["default"](container, 10, 10, 10);
minesweeper.start();
})();
